#ifndef FIRMWARE_CORE_CONFIG_PRODUCT_MANIFEST_H
#define FIRMWARE_CORE_CONFIG_PRODUCT_MANIFEST_H

#include <stdint.h>

#define PRODUCT_ID_VECTOR_MINI_ST 0x564D5354UL
#define PRODUCT_MCU_ID_STM32G431 0x00000431UL
#define PRODUCT_STORAGE_LAYOUT_COMPATIBILITY_ID 1U
#define PRODUCT_PARAMETER_SCHEMA_VERSION 10U
#define PRODUCT_BOOT_IMAGE_CONTRACT_VERSION 1U
