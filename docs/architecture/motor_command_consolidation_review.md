...
当前已确认仅 CAN FD，仲裁 500 kbit/s、数据 5 Mbit/s、BRS=1，全部使用公司完整帧。基线有效消息 65 种（63 请求、2 上报），已采用 type=124 单帧合并反馈；本文件仅评审进一步精简，未替换[当前命令表](../protocols/motor_command_catalog.md)。
