...
DEFAULT_PROFILE = ROOT / "tests/hil/profiles/mode3/bench_20260908.json"
...
def metadata():
    ...
    files = ["firmware/motor/position/position_cascade.c", "firmware/motor/position/position_cascade_config.h",
             "firmware/motor/trajectory/position_smooth_trajectory.c", "firmware/app/foc_run.c", "firmware/services/parameters/foc_param.h",
             "tools/bench/run_mode3_validation.py", "tests/unit/native/run_position_servo_tests.py",
             "tests/integration/test_mode3_validation.py", "tests/unit/position_servo_test.c",
...
def host_tests(cc, out):
    ...
    commands = [[sys.executable, str(ROOT / "tests/unit/native/run_position_servo_tests.py"), "--out", str(out / "native")]]
