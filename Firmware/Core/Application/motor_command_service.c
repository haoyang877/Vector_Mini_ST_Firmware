...
enum
{
	...
	ACTION_CODE_CALIBRATE_ENCODER_DIRECTION = 20U,
	ACTION_CODE_FULL_COMMISSIONING = 21U,
	ACTION_CODE_COUNT = 22U
};
	...
	switch (action_code)
	{
		...
		case ACTION_CODE_CALIBRATE_COGGING:
			return port->request_service(port->context,
				...
				MOTOR_COMMAND_ACCEPTED : MOTOR_COMMAND_INVALID_STATE;
		case ACTION_CODE_CALIBRATE_ENCODER_DIRECTION:
			return port->request_service(port->context,
				MOTOR_PORT_SERVICE_ENCODER_DIRECTION_CALIBRATION) ?
				MOTOR_COMMAND_ACCEPTED : MOTOR_COMMAND_INVALID_STATE;
		case ACTION_CODE_FULL_COMMISSIONING:
			return port->request_service(port->context,
