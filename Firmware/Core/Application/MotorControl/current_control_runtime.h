#ifndef CORE_APPLICATION_MOTOR_CONTROL_CURRENT_CONTROL_RUNTIME_H
#define CORE_APPLICATION_MOTOR_CONTROL_CURRENT_CONTROL_RUNTIME_H

#include "motor_control_types.h"
#include "pi_controller.h"
#include "Core/Application/MotorControl/motor_drive_service.h"
#include "Core/Services/Measurement/phase_current_strategy.h"
...
typedef struct
{
	...
	MotorDriveServiceAcquisition measurement_acquisition;
	/* Exact low-level reason retained for debugger/diagnostic projection when
	 * a malformed or stale acquisition shuts the drive down. */
