...
SERVO_HEADER = ROOT / "firmware/motor/position/position_cascade.h"
SERVO_SOURCE = ROOT / "firmware/motor/position/position_cascade.c"
FOC_ADAPTER = ROOT / "firmware/app/foc_run.c"
