#ifndef CORE_APPLICATION_MOTOR_CONTROL_PHASE_RESISTANCE_RUNTIME_H
#define CORE_APPLICATION_MOTOR_CONTROL_PHASE_RESISTANCE_RUNTIME_H
...
typedef struct
{
	...
	ProductPhaseResistanceCommissioningConfig tuning;
...
PhaseResistanceRuntimeStatus PhaseResistanceRuntime_Run(
	...
	const PhaseResistanceRuntimeBoardConfig *config);
