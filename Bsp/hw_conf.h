...
#define RTT_SAMPLE_RATE_HZ		5000U
...
#define SENSORLESS_STARTUP_TARGET_ELEC_VEL_RAD_S   500.0f
#define SENSORLESS_STARTUP_OPEN_LOOP_TIME_S        1.50f
...
#define SENSORLESS_OBSERVER_LOCK_TIME_S            0.10f
#define SENSORLESS_ANGLE_HANDOFF_TIME_S            0.05f
