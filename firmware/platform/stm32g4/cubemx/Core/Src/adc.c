...
void MX_ADC2_Init(void)
{
  ...
  */
   ...
   * Retain the sum; sensing converts it to fractional 12-bit units in float.
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PC4     ------> ADC2_IN5
    */
    GPIO_InitStruct.Pin = ADC_VBUS_Pin|ADC_IA_Pin|ADC_IB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_IC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_IC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC4     ------> ADC2_IN5
    */
    HAL_GPIO_DeInit(GPIOA, ADC_VBUS_Pin|ADC_IA_Pin|ADC_IB_Pin);

    HAL_GPIO_DeInit(ADC_IC_GPIO_Port, ADC_IC_Pin);
