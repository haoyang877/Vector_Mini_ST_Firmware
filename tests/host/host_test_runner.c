...
static const HostTestCase HostTests[] =
{
	...
	{ "can_command_router", CanCommandRouter_RunHostTests },
	...
	{ "fast_math", FastMath_RunHostTests },
	{ "feedback_router", FeedbackRouter_RunHostTests },
	{ "rotor_feedback_runtime", RotorFeedbackRuntime_RunHostTests },
	...
	{ "measurement_runtime", MeasurementRuntime_RunHostTests },
	{ "motor_drive_service", MotorDriveService_RunHostTests },
	{ "phase_current_strategy", PhaseCurrentStrategy_RunHostTests },
	{ "temperature_monitor", TemperatureMonitor_RunHostTests },
	{ "temperature_supervision", TemperatureSupervision_RunHostTests },
	{ "product_catalog_variants", ProductCatalogVariant_RunHostTests },
	{ "motor_commissioning_workflow", MotorCommissioningWorkflow_RunHostTests },
	{ "parameter_manager", ParameterManager_RunHostTests },
	{ "parameter_persistence_adapter", ParameterPersistenceAdapter_RunHostTests },
	...
	{ "usb_command_router", UsbCommandRouter_RunHostTests },
	{ "usb_interface", UsbInterface_RunHostTests }
};
