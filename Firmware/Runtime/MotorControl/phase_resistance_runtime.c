...
static float PhaseResistanceRuntime_LimitCurrent(const MotorControlContext *motor,
	const MotorProfile *motor_profile, float requested_current)
{
	float maximum_current = motor_profile->phase_resistance_test_current_max_a;
	...
	const MotorProfile *motor_profile)
{
	...
	config.test_current_low = PhaseResistanceRuntime_LimitCurrent(motor,
		motor_profile, motor_profile->phase_resistance_test_current_low_a);
	config.test_current_high = PhaseResistanceRuntime_LimitCurrent(motor,
		motor_profile, motor_profile->phase_resistance_test_current_high_a);
	...
	config.q_current_tolerance =
		motor_profile->phase_resistance_q_current_tolerance_a;
	config.voltage_tolerance =
		motor_profile->phase_resistance_voltage_tolerance_v;
	config.voltage_min_delta =
		motor_profile->phase_resistance_voltage_min_delta_v;
	...
	config.balance_fault_pct =
		motor_profile->phase_resistance_balance_fault_pct;
