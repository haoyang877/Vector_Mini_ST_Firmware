...
#define SENSORLESS_ALIGN_TIME_S                                                                    \
    (SENSORLESS_ALIGN_CURRENT_RAMP_TIME_S + SENSORLESS_ALIGN_HOLD_TIME_S)
...
#define SENSORLESS_STARTUP_ELEC_ACCEL_RAD_S2                                                       \
    (SENSORLESS_STARTUP_TARGET_ELEC_VEL_RAD_S / SENSORLESS_STARTUP_RAMP_TIME_S)
